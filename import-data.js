// Import script for PocketBase mock data
// Run this after creating collections in PocketBase Admin UI
...
const opportunities = [
  ...
  },
  {
    ...
    "description": "Seeking experienced commercial contractor for complete office renovation. Modern open-plan design, sustainable materials, smart building integration. Timeline: 3 months.",
    "type": "RFP",
    "status": "Open",
    "budget": "$500K-$750K",
    "deadline": "2024-07-25",
  ...
  },
  {
    ...
    "description": "Looking for technology partner to co-develop a B2B SaaS platform for the construction industry. Seeking expertise in cloud architecture, mobile development, and AI/ML.",
    "type": "Collaboration",
    "status": "Open",
  ...
  },
  {
    ...
    "description": "Need full-service marketing agency for Q4 product launch. Includes brand strategy, content creation, social media, and paid advertising across multiple channels.",
    "type": "Project",
    "status": "Open",
    "budget": "$75K-$125K",
    "deadline": "2024-08-10",
  ...
  },
  {
    ...
    "description": "We're a growing e-commerce business looking for a reliable logistics partner to handle our nationwide distribution. Need warehousing in 3+ locations and real-time tracking capabilities. Expected volume: 5000+ shipments/month.",
    "type": "Partnership",
    "status": "Open",
  ...
  },
  {
    ...
    "description": "Looking for eco-friendly packaging manufacturer for our new product line. Need sustainable materials, custom design capabilities, and ability to scale from 10K to 100K units.",
    "type": "Project",
    "status": "Open",
    "budget": "$25K-$50K",
    "deadline": "2024-07-30",
...
const offers = [
  ...
  },
  {
    ...
    "description": "Get 30% off our enterprise software solutions for new clients signing before August 31st. Includes custom development, cloud hosting, and 6 months support.",
    "company_name": "TechFlow Solutions",
  ...
  },
  {
    ...
    "description": "Order eco-friendly packaging materials worth $10K or more and get free nationwide shipping. Limited time offer for new partnerships.",
    "company_name": "GreenLeaf Manufacturing",
    "discount_percentage": 15,
  ...
  },
  {
    ...
    "description": "New clients get their first month of BI consulting completely free. Includes data analysis, dashboard setup, and strategic insights.",
    "company_name": "DataDrive Analytics",
  ...
  },
  {
    ...
    "description": "Launch your brand with our comprehensive digital marketing packages. 20% off for SMBs starting their first campaign with us.",
    "company_name": "BrandSpark Marketing",
    "discount_percentage": 20,
...
console.log('=== MOCK DATA FOR POCKETBASE ===\n');
console.log('Total Businesses:', businesses.length);
console.log('Total Opportunities:', opportunities.length);
console.log('Total Offers:', offers.length);
console.log('\nCopy these JSON arrays to import in PocketBase Admin UI\n');
