...
async function importData() {
  console.log('🚀 Starting PocketBase data import with authentication...\n');

  try {
    // Authenticate as admin
    console.log('🔐 Please enter your PocketBase admin credentials:\n');
    ...
    console.log(`✨ Businesses: ${successCount}/${businesses.length} created\n`);
    ...
    console.log(`✨ Opportunities: ${successCount}/${opportunities.length} created\n`);
    ...
    console.log(`✨ Offers: ${successCount}/${offers.length} created\n`);
